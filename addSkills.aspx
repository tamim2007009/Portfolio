...
<br />
<br />
<asp:Button ID="addButton" runat="server" Text="Add" OnClick="addButton_Click" BackColor="DarkBlue" ForeColor="White" Font-Bold="true" Font-Size="Large" Width="100px" Height="50px" />
